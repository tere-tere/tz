        ...
        <div :id="'car_client'+index" >
            ...
            <div class="form-row">
                ...
                <div class="form-check">
                    ...
                    <input class="form-check-input" name='car_in_place' type="checkbox" id="gridCheck1" value="on"  v-model="cars[index].car_in_place" true-value='1' :checked="cars[index].car_in_place" >
                </div>
            </div>
        </div>
    </div>
